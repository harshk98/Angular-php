...
export class BackendComponent implements OnInit {
    ...
    getData(){
        this.http.get('http://localhost/backend/api/read.php').subscribe(
            data => {
                this.fetchdata = data;
    ...
    PostData(dataForm) {
        this.http.post('http://localhost/backend/api/create.php', dataForm).subscribe(
            data => {
    ...
    updateData(dataForm) {
        this.http.post('http://localhost/backend/api/update.php', dataForm).subscribe(
            data => {
    ...
    deleteData(dataForm) {
        this.http.post('http://localhost/backend/api/delete.php', dataForm).subscribe(
            data => {
